...
ode_sigmoid_effectiveDose_G1_only_Dox <- function(params, init, tmax, dose_times, drug_amount, 
                                                                                                                       passage_day, passage_number){
  #if (dose_times[1] > 0 ){
    #dose_times = c(0, dose_times)
    #drug_amount = rbind(c(0,0), drug_amount)
  ...
  #for ( i in drug_idx){
    ...
    init["PP"] = drug_amount[2]*1e2
    init["FF"] = drug_amount[1]*1e3
    
    init_num = as.numeric(init)
    names(init_num) = names(init)
    out = ode(parms = params,
              func = ode_simulation_G1_only_Dox,
              y = init_num,
              times = seq(dose_times, tmax, by = 0.05))
    #init = out[out[,"time"] == t_end, c("G0G1_1", "G0G1_2", "G0G1_3", "G0G1_4", "G0G1_5", "G0G1_6", "G0G1_7", "S_1", "S_2", "S_3", "S_4", "S_5", "S_6",  "S_7", "G2M_1", "G2M_2",  "PP","FF")]
    outdf = data.frame(out)
    results = outdf
...
ode_sigmoid_effectiveDose_G1_only_Dox_tr <- function(params, init, grwoth_rate, tmax, dose_times, drug_amount, 
                                                  passage_day, passage_number){
  #if (dose_times[1] > 0 ){
  #dose_times = c(0, dose_times)
  #drug_amount = rbind(c(0,0), drug_amount)
  ...
  names(init_num) = names(init)
  out = ode(parms = params,
            func = ode_simulation_G1_only_Dox_tr,
            y = init_num,
            gr = grwoth_rate,
            times = seq(dose_times, tmax, by = 0.05))
  #init = out[out[,"time"] == t_end, c("G0G1_1", "G0G1_2", "G0G1_3", "G0G1_4", "G0G1_5", "G0G1_6", "G0G1_7", "S_1", "S_2", "S_3", "S_4", "S_5", "S_6",  "S_7", "G2M_1", "G2M_2",  "PP","FF")]
...
ode_sigmoid_effectiveDose_even_9_only_Dox <- function(params, init, tmax, dose_times, drug_amount, 
                                                  passage_day, passage_number){
  #if (dose_times[1] > 0 ){
  #dose_times = c(0, dose_times)
  #drug_amount = rbind(c(0,0), drug_amount)
  ...
  names(init_num) = names(init)
  out = ode(parms = params,
            func = ode_simulation_even_9_only_Dox,
            y = init_num,
            times = seq(dose_times, tmax, by = 0.05))
  #init = out[out[,"time"] == t_end, c("G0G1_1", "G0G1_2", "G0G1_3", "G0G1_4", "G0G1_5", "G0G1_6", "G0G1_7", "S_1", "S_2", "S_3", "S_4", "S_5", "S_6",  "S_7", "G2M_1", "G2M_2",  "PP","FF")]
  outdf = data.frame(out)
...
ode_simulation_G1_only_Dox <- function(t, y, params){
  alpha = params$alpha
  gamma = params$gamma
  delta = params$delta
  b_P = params$b_P
  ...
  dG0G1_1 = 2*delta*y["G2M_2"] - alpha*y["G0G1_1"]; # G0G1 compartment
  dG0G1_2 = alpha*y["G0G1_1"] - beta*y["G0G1_2"]; 

  
  dS_1= beta*y["G0G1_2"] - gamma*y["S_1"]; # S compartment
  dS_2= gamma*y["S_1"] - gamma*y["S_2"];

  
  dG2M_1 = gamma*y["S_2"] - delta*y["G2M_1"];   # G2M compartment
  dG2M_2 = delta*y["G2M_1"] - delta*y["G2M_2"];
  
  dP = 0
  dF = 0
  
  return(list(c(dG0G1_1, dG0G1_2,  dS_1, dS_2,  dG2M_1, dG2M_2,  dP, dF)))
  
}

ode_simulation_G1_only_Dox_tr <- function(t, y, params){
  alpha = gr*(params$alpha)
  gamma = params$gamma
  delta = params$delta
  b_P = params$b_P
  b_F = params$b_F
...
ode_simulation_even_9_only_Dox <- function(t, y, params){
  alpha = params$alpha
  b_P = params$b_P
  b_F = params$b_F
  c_P = params$c_P
  ...
  drugF_eff = y["FF"] * (1 + 0.1*a_FP * ((y["PP"]/c_P)/(1 + (y["PP"]/c_P))))^(-1) ;
  beta = alpha*(1/(1 + (y["PP"]/c_P)^b_P))*(1/(1 + (drugF_eff/c_F)^(b_F)));
  
  
  dG0G1_1 = 2*alpha*y["G2M_3"] - alpha*y["G0G1_1"]; # G0G1 compartment
  dG0G1_2 = alpha*y["G0G1_1"] - alpha*y["G0G1_2"]; 
  dG0G1_3 = alpha*y["G0G1_2"] - beta*y["G0G1_3"]; 
 
  
  dS_1= beta*y["G0G1_3"] - alpha*y["S_1"]; # S compartment
  dS_2= alpha*y["S_1"] - alpha*y["S_2"];
  dS_3= alpha*y["S_2"] - alpha*y["S_3"];
 
  
  dG2M_1 = alpha*y["S_3"] - alpha*y["G2M_1"];   # G2M compartment
  dG2M_2 = alpha*y["G2M_1"] - alpha*y["G2M_2"];
  dG2M_3 = alpha*y["G2M_2"] - alpha*y["G2M_3"];
  ...
  return(list(c(dG0G1_1, dG0G1_2, dG0G1_3, dS_1, dS_2, dS_3,  dG2M_1, dG2M_2, dG2M_3, dP, dF)))
  
}

ode_sigmoid_effectiveDose_G1_only_ND <- function(params, init, tmax, dose_times, drug_amount, 
                                              passage_day, passage_number){
  #if (dose_times[1] > 0 ){
  #dose_times = c(0, dose_times)
  #drug_amount = rbind(c(0,0), drug_amount)
  ...
  init["PP"] = drug_amount[2]*1e2
  init["FF"] = drug_amount[1]*1e8
  
  init_num = as.numeric(init)
  names(init_num) = names(init)
  out = ode(parms = params,
            func = ode_simulation_G1_only_ND,
            y = init_num,
            times = seq(dose_times, tmax, by = 0.05))
  #init = out[out[,"time"] == t_end, c("G0G1_1", "G0G1_2", "G0G1_3", "G0G1_4", "G0G1_5", "G0G1_6", "G0G1_7", "S_1", "S_2", "S_3", "S_4", "S_5", "S_6",  "S_7", "G2M_1", "G2M_2",  "PP","FF")]
  outdf = data.frame(out)
...
ode_sigmoid_effectiveDose_even_9_only_ND <- function(params, init, tmax, dose_times, drug_amount, 
                                                 passage_day, passage_number){
  #if (dose_times[1] > 0 ){
  #dose_times = c(0, dose_times)
  #drug_amount = rbind(c(0,0), drug_amount)
  ...
  names(init_num) = names(init)
  out = ode(parms = params,
            func = ode_simulation_even_9_only_ND,
            y = init_num,
            times = seq(dose_times, tmax, by = 0.05))
  #init = out[out[,"time"] == t_end, c("G0G1_1", "G0G1_2", "G0G1_3", "G0G1_4", "G0G1_5", "G0G1_6", "G0G1_7", "S_1", "S_2", "S_3", "S_4", "S_5", "S_6",  "S_7", "G2M_1", "G2M_2",  "PP","FF")]
  outdf = data.frame(out)
...
ode_sigmoid_effectiveDose_G1_only_ND_PalboResist_weak <- function(params, init, tmax, dose_times, drug_amount, 
                                                 passage_day, passage_number){
  #if (dose_times[1] > 0 ){
  #dose_times = c(0, dose_times)
  #drug_amount = rbind(c(0,0), drug_amount)
  ...
  names(init_num) = names(init)
  out = ode(parms = params,
            func = ode_simulation_G1_only_ND_PalboResist_weak,
            y = init_num,
            times = seq(dose_times, tmax, by = 0.05))
  #init = out[out[,"time"] == t_end, c("G0G1_1", "G0G1_2", "G0G1_3", "G0G1_4", "G0G1_5", "G0G1_6", "G0G1_7", "S_1", "S_2", "S_3", "S_4", "S_5", "S_6",  "S_7", "G2M_1", "G2M_2",  "PP","FF")]
  outdf = data.frame(out)
...
ode_sigmoid_effectiveDose_G1_only_ND_PalboResist_strong <- function(params, init, tmax, dose_times, drug_amount, 
                                                                  passage_day, passage_number){
  #if (dose_times[1] > 0 ){
  #dose_times = c(0, dose_times)
  #drug_amount = rbind(c(0,0), drug_amount)
  ...
  names(init_num) = names(init)
  out = ode(parms = params,
            func = ode_simulation_G1_only_ND_PalboResist_strong,
            y = init_num,
            times = seq(dose_times, tmax, by = 0.05))
  #init = out[out[,"time"] == t_end, c("G0G1_1", "G0G1_2", "G0G1_3", "G0G1_4", "G0G1_5", "G0G1_6", "G0G1_7", "S_1", "S_2", "S_3", "S_4", "S_5", "S_6",  "S_7", "G2M_1", "G2M_2",  "PP","FF")]
  outdf = data.frame(out)
...
ode_sigmoid_effectiveDose_G1_only_ND_tr_weak <- function(params, init, tmax, dose_times, drug_amount, 
                                                                  passage_day, passage_number){
  #if (dose_times[1] > 0 ){
  #dose_times = c(0, dose_times)
  #drug_amount = rbind(c(0,0), drug_amount)
  ...
  names(init_num) = names(init)
  out = ode(parms = params,
            func = ode_simulation_G1_only_ND_tr_weak,
            y = init_num,
            times = seq(dose_times, tmax, by = 0.05))
  #init = out[out[,"time"] == t_end, c("G0G1_1", "G0G1_2", "G0G1_3", "G0G1_4", "G0G1_5", "G0G1_6", "G0G1_7", "S_1", "S_2", "S_3", "S_4", "S_5", "S_6",  "S_7", "G2M_1", "G2M_2",  "PP","FF")]
  outdf = data.frame(out)
...
ode_sigmoid_effectiveDose_G1_only_ND_tr_strong <- function(params, init, tmax, dose_times, drug_amount, 
                                                                    passage_day, passage_number){
  #if (dose_times[1] > 0 ){
  #dose_times = c(0, dose_times)
  #drug_amount = rbind(c(0,0), drug_amount)
  ...
  names(init_num) = names(init)
  out = ode(parms = params,
            func = ode_simulation_G1_only_ND_tr_strong,
            y = init_num,
            times = seq(dose_times, tmax, by = 0.05))
  #init = out[out[,"time"] == t_end, c("G0G1_1", "G0G1_2", "G0G1_3", "G0G1_4", "G0G1_5", "G0G1_6", "G0G1_7", "S_1", "S_2", "S_3", "S_4", "S_5", "S_6",  "S_7", "G2M_1", "G2M_2",  "PP","FF")]
  outdf = data.frame(out)
...
ode_sigmoid_effectiveDose_G1_only_Dox_PalboResist_weak <- function(params, init, tmax, dose_times, drug_amount, 
                                                                  passage_day, passage_number){
  #if (dose_times[1] > 0 ){
  #dose_times = c(0, dose_times)
  #drug_amount = rbind(c(0,0), drug_amount)
  ...
  names(init_num) = names(init)
  out = ode(parms = params,
            func = ode_simulation_G1_only_Dox_PalboResist_weak,
            y = init_num,
            times = seq(dose_times, tmax, by = 0.05))
  #init = out[out[,"time"] == t_end, c("G0G1_1", "G0G1_2", "G0G1_3", "G0G1_4", "G0G1_5", "G0G1_6", "G0G1_7", "S_1", "S_2", "S_3", "S_4", "S_5", "S_6",  "S_7", "G2M_1", "G2M_2",  "PP","FF")]
  outdf = data.frame(out)
...
ode_sigmoid_effectiveDose_G1_only_Dox_PalboResist_strong <- function(params, init, tmax, dose_times, drug_amount, 
                                                                    passage_day, passage_number){
  #if (dose_times[1] > 0 ){
  #dose_times = c(0, dose_times)
  #drug_amount = rbind(c(0,0), drug_amount)
  ...
  names(init_num) = names(init)
  out = ode(parms = params,
            func = ode_simulation_G1_only_Dox_PalboResist_strong,
            y = init_num,
            times = seq(dose_times, tmax, by = 0.05))
  #init = out[out[,"time"] == t_end, c("G0G1_1", "G0G1_2", "G0G1_3", "G0G1_4", "G0G1_5", "G0G1_6", "G0G1_7", "S_1", "S_2", "S_3", "S_4", "S_5", "S_6",  "S_7", "G2M_1", "G2M_2",  "PP","FF")]
  outdf = data.frame(out)
...
ode_sigmoid_effectiveDose_G1_only_Dox_tr_weak <- function(params, init, tmax, dose_times, drug_amount, 
                                                                   passage_day, passage_number){
  #if (dose_times[1] > 0 ){
  #dose_times = c(0, dose_times)
  #drug_amount = rbind(c(0,0), drug_amount)
  ...
  names(init_num) = names(init)
  out = ode(parms = params,
            func = ode_simulation_G1_only_Dox_tr_weak,
            y = init_num,
            times = seq(dose_times, tmax, by = 0.05))
  #init = out[out[,"time"] == t_end, c("G0G1_1", "G0G1_2", "G0G1_3", "G0G1_4", "G0G1_5", "G0G1_6", "G0G1_7", "S_1", "S_2", "S_3", "S_4", "S_5", "S_6",  "S_7", "G2M_1", "G2M_2",  "PP","FF")]
  outdf = data.frame(out)
...
ode_sigmoid_effectiveDose_G1_only_Dox_tr_strong <- function(params, init, tmax, dose_times, drug_amount, 
                                                                     passage_day, passage_number){
  #if (dose_times[1] > 0 ){
  #dose_times = c(0, dose_times)
  #drug_amount = rbind(c(0,0), drug_amount)
  ...
  names(init_num) = names(init)
  out = ode(parms = params,
            func = ode_simulation_G1_only_Dox_tr_strong,
            y = init_num,
            times = seq(dose_times, tmax, by = 0.05))
  #init = out[out[,"time"] == t_end, c("G0G1_1", "G0G1_2", "G0G1_3", "G0G1_4", "G0G1_5", "G0G1_6", "G0G1_7", "S_1", "S_2", "S_3", "S_4", "S_5", "S_6",  "S_7", "G2M_1", "G2M_2",  "PP","FF")]
  outdf = data.frame(out)
...
ode_simulation_G1_only_ND <- function(t, y, params){
  alpha = params$alpha
  gamma = params$gamma
  delta = params$delta
  b_P = params$b_P
  ...
  dG0G1_1 = 2*delta*y["G2M_8"] - alpha*y["G0G1_1"]; # G0G1 compartment
  dG0G1_2 = alpha*y["G0G1_1"] - alpha*y["G0G1_2"]; 
  dG0G1_3 = alpha*y["G0G1_2"] - alpha*y["G0G1_3"]; 
  dG0G1_4 = alpha*y["G0G1_3"] - alpha*y["G0G1_4"]; 
  dG0G1_5 = alpha*y["G0G1_4"] - alpha*y["G0G1_5"]; 
  ...
  dS_1= beta*y["G0G1_8"] - gamma*y["S_1"]; # S compartment
  dS_2= gamma*y["S_1"] - gamma*y["S_2"];
  dS_3= gamma*y["S_2"] - gamma*y["S_3"];
  dS_4= gamma*y["S_3"] - gamma*y["S_4"];
  dS_5= gamma*y["S_4"] - gamma*y["S_5"];
  dS_6= gamma*y["S_5"] - gamma*y["S_6"];
  dS_7= gamma*y["S_6"] - gamma*y["S_7"];
  dS_8= gamma*y["S_7"] - gamma*y["S_8"];
  
  dG2M_1 = gamma*y["S_8"] - delta*y["G2M_1"];   # G2M compartment
  dG2M_2 = delta*y["G2M_1"] - delta*y["G2M_2"];
  dG2M_3 = delta*y["G2M_2"] - delta*y["G2M_3"];
  dG2M_4 = delta*y["G2M_3"] - delta*y["G2M_4"];
  dG2M_5 = delta*y["G2M_4"] - delta*y["G2M_5"];
  dG2M_6 = delta*y["G2M_5"] - delta*y["G2M_6"];
  dG2M_7 = delta*y["G2M_6"] - delta*y["G2M_7"];
  dG2M_8 = delta*y["G2M_7"] - delta*y["G2M_8"];
  ...
  return(list(c(dG0G1_1, dG0G1_2, dG0G1_3, dG0G1_4, dG0G1_5, dG0G1_6, dG0G1_7, dG0G1_8,  
                dS_1, dS_2, dS_3, dS_4, dS_5, dS_6, dS_7, dS_8, 
                dG2M_1, dG2M_2, dG2M_3, dG2M_4, dG2M_5, dG2M_6, dG2M_7, dG2M_8, 
                dP, dF)))
  
}


ode_simulation_even_9_only_ND <- function(t, y, params){
  alpha = params$alpha
  b_P = params$b_P
  b_F = params$b_F
  c_P = params$c_P
  ...
  drugF_eff = y["FF"] * (1 + 0.1*a_FP * ((y["PP"]/c_P)/(1 + (y["PP"]/c_P))))^(-1) ;
  beta = (alpha)*(1/(1 + (y["PP"]/c_P)^b_P))*(1/(1 + (drugF_eff/c_F)^(0.1*b_F)));
...
ode_simulation_G1_only_ND_PalboResist_weak <- function(t, y, params){
  alpha = params$alpha
  gamma = params$gamma
  delta = params$delta
  b_P = params$b_P
  b_P_PalboResist_weak = b_P*0.5
  b_F = params$b_F
  c_P = params$c_P
  c_P_PalboResist_weak = c_P*10
  c_F = params$c_F
  ...
  drugF_eff = y["FF"] * (1 + 0.1*a_FP * ((y["PP"]/c_P_PalboResist_weak)/(1 + (y["PP"]/c_P_PalboResist_weak))))^(-1) ;
  beta = 0.1*alpha_max + (alpha - 0.1*alpha_max)*(1/(1 + (y["PP"]/c_P_PalboResist_weak)^b_P_PalboResist_weak))*(1/(1 + (drugF_eff/c_F)^(0.1*b_F)));  
...
ode_simulation_G1_only_ND_PalboResist_strong <- function(t, y, params){
  alpha = params$alpha
  gamma = params$gamma
  delta = params$delta
  b_P = params$b_P
  b_P_PalboResist_strong = b_P*0.5
  b_F = params$b_F
  c_P = params$c_P
  c_P_PalboResist_strong = c_P*1e5
  c_F = params$c_F
  ...
  drugF_eff = y["FF"] * (1 + 0.1*a_FP * ((y["PP"]/c_P_PalboResist_strong)/(1 + (y["PP"]/c_P_PalboResist_strong))))^(-1) ;
  beta = 0.1*alpha_max + (alpha - 0.1*alpha_max)*(1/(1 + (y["PP"]/c_P_PalboResist_strong)^b_P_PalboResist_strong))*(1/(1 + (drugF_eff/c_F)^(0.1*b_F)));  
...
ode_simulation_G1_only_ND_tr_weak <- function(t, y, params){
  alpha = 1.5*(params$alpha)
  gamma = params$gamma
  delta = params$delta
  b_P = params$b_P
  b_P_PalboResist_weak = b_P
  b_F = params$b_F
  c_P = params$c_P
  c_P_PalboResist_weak = c_P
  c_F = params$c_F
...
ode_simulation_G1_only_ND_tr_strong <- function(t, y, params){
  alpha = 3*(params$alpha)
  gamma = params$gamma
  delta = params$delta
  b_P = params$b_P
  b_P_PalboResist_strong = b_P
  b_F = params$b_F
  c_P = params$c_P
  c_P_PalboResist_strong = c_P
  c_F = params$c_F
...
ode_simulation_G1_only_Dox_PalboResist_weak <- function(t, y, params){
  alpha = params$alpha
  gamma = params$gamma
  delta = params$delta
  b_P = params$b_P
  ...
  drugF_eff = y["FF"] * (1 + 0.1*a_FP * ((y["PP"]/c_P_PalboResist_weak)/(1 + (y["PP"]/c_P_PalboResist_weak))))^(-1) ;
  beta = alpha_max + (alpha - alpha_max)*(1/(1 + (y["PP"]/c_P_PalboResist_weak)^b_P_PalboResist_weak))*(1/(1 + (drugF_eff/c_F)^(b_F)));
...
ode_simulation_G1_only_Dox_PalboResist_strong <- function(t, y, params){
  alpha = params$alpha
  gamma = params$gamma
  delta = params$delta
  b_P = params$b_P
  ...
  drugF_eff = y["FF"] * (1 + 0.1*a_FP * ((y["PP"]/c_P_PalboResist_strong)/(1 + (y["PP"]/c_P_PalboResist_strong))))^(-1) ;
  beta = alpha_max + (alpha - alpha_max)*(1/(1 + (y["PP"]/c_P_PalboResist_strong)^b_P_PalboResist_strong))*(1/(1 + (drugF_eff/c_F)^(b_F)));
...
ode_simulation_G1_only_Dox_tr_weak <- function(t, y, params){
  alpha = 1.5*(params$alpha)
  gamma = params$gamma
  delta = params$delta
  b_P = params$b_P
...
ode_simulation_G1_only_Dox_tr_strong <- function(t, y, params){
  alpha = 3*(params$alpha)
  gamma = params$gamma
  delta = params$delta
  b_P = params$b_P
